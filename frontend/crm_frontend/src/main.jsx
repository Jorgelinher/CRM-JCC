/*frontend/crm_frontend/src/main.jsx*/
...
import DashboardPage from './pages/Dashboard/DashboardPage.jsx'; /* Ya existe*/
        ...
        <AuthProvider>
          <Routes>
            ...
            >
              ...
              <Route path="dashboard" element={<DashboardPage />} /> # Esta es la ruta para el dashboard de métricas
